...
if __name__ == '__main__':
    ...
    pseudo_aligned_val_set = EmbeddingDataset(
        build_pseudo_aligned_dataset(aligned_val_set, distance='Euclidean', topk=topk),  mode='aligned')
    ...
    print("Time taken for training:", time.time() - train_begin)
