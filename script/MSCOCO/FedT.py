...
if __name__ == '__main__':
    train_pretrained_file = '/data2/kudret/codes/FedML/pretrained_embeddings/MSCOCO/clip_embeddings_with_category.pt'
    val_pretrained_file = '/data2/kudret/codes/FedML/pretrained_embeddings/MSCOCO/clip_embeddings_with_category_val.pt'
    ...
    original_pseudo_aligned_val_set = build_pseudo_aligned_dataset(aligned_val_set, distance='Euclidean', topk=topk)
    noise_pseudo_aligned_val_set = add_gaussian_noise_to_embeddings(original_pseudo_aligned_val_set, noise_level=0.1)
    pseudo_aligned_val_set = EmbeddingDataset(noise_pseudo_aligned_val_set, mode='aligned')
    pseudo_aligned_val_loader = DataLoader(pseudo_aligned_val_set, batch_size=batch_size, shuffle=False)
    ...
    for epoch in range(num_epochs):
        ...
        pseudo_aligned_val_metrics = evaluate_retrieval(pseudo_aligned_model, pseudo_aligned_val_loader, device)
        print(f"Validation Metrics: {pseudo_aligned_val_metrics}")
